<div class="flex flex-col gap-2 md:gap-4 lg:gap-6"
    ...
    <div class="d-card bg-base-100 flex flex-col gap-2 md:gap-4 lg:gap-6 p-2 md:p-4 lg:p-6">
        <button @click="modalForm=true" class="d-btn d-btn-primary w-fit">
            <flux:icon :icon="'plus'"></flux:icon>Tambah Anggota
        </button>
        <table class="d-table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="3" class="text-base-content/60 ">-- tidak ada data anggota --</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div x-show="modalForm" class="fixed top-0 left-0 z-[99] flex items-start justify-center w-screen h-screen"
        ...
        <div x-show="modalForm"
            ...
            <form wire:submit.prevent="save">
                ...
                <div class="flex flex-col">
                    <div class="font-medium transition-colors duration-300" :class="invalid.nama ? 'text-error':'text-base-content'">Nama Anggota</div>
                    <input @input="invalid['nama']='';invalid.invalid=''" type="text" wire:model="nama" class="d-input">
                </div>
                <div class="flex flex-col my-2 md:my-4 lg:my-6">
                    <div class="font-medium transition-colors duration-300" :class="invalid.tanggal_lahir ? 'text-error':'text-base-content'">Tanggal Lahir</div>
                    <input @input="invalid['tanggal_lahir']='';invalid.invalid=''" wire:model="tanggal_lahir" type="date" class="d-input">
                </div>
    ...
    <div x-show="modalConfirm" class="fixed top-0 left-0 z-[99] flex items-start justify-center w-screen h-screen"
        ...
        <div x-show="modalConfirm"
            ...
            <div class="">Anda akan menghapus anggota <br><span class="font-medium">{{$selectedAnggota ? $selectedAnggota['nama'] : '-- nama anggota --'}}</span>?</div>
